            ...
            <div>
                ...
                <div className="container">
                    <div className="row banner-wrapper">
                        ...
                        <div className="col-md-6 content-div">
                            <h1>Providing The Best <br /> <span>Human Capital Solutions</span> All Over The Globe</h1>
                            <p>Quality services on various aspects of human resources and letting the organization specialize in its prior development to urge future ideas.</p>
                ...
                <div className="container">
                    <div className="aboutus-wrapper">
                        <h1>We Make Our Services <br /><span>Extraterrestrial.</span></h1>
                        <div className="row">
                            <div className="aboutus-content d-flex">
                                ...
                                <div className="col-md-7">
                                    <p>We all know innovations and challenges are the corner stone of business that underlays the very existence of businesses.  The challenges encountered in business and leadership translates into a problem-solving and target driven work force.  With evolving business needs, EC Staff provides the cutting-edge human capital to aid in business needs.</p>
