                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            <p>Easy Staff Solutions primarily engages in Human Capital responses or traditionally Manpower Supply & Human Resource Consulting incorporated in the year 2013 to fill the market gap between skilled and semi-skilled workforce. From a frugal start with a few dedicated employees, we are 3000+ strong with skilled and semi-skilled work force across various geographic locations.</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div className="col-sm-6 col-md-4 crd">
                            <div className="card">
                                <div className="card-body">
                                    <img src={vision} />
                                    <h2>Our Vision</h2>
                                    <p>Anticipating and meeting the changing needs of the workforce; Championing career and professional growth, enhancing services through innovation and creativity; Demonstrating and maintaining a healthy work environment both physically and mentally.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-sm-6 col-md-4 crd">
                            <div className="card">
                                <div className="card-body">
                                    <img src={mission} />
                                    <h2>Our Mission</h2>
                                    <p>To supply outstanding service and solutions through dedication and excellence. To develop and manage value-added human resources policies and programs and provide expert consultation, services and solutions in an efficient and customer-focused manner; and to provide top-end employees to meet our customers' needs.
                                    </p>
                                </div>
                            </div>
                        </div>
