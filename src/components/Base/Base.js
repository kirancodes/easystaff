                        ...
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col-7 col-md-2">
                                    <h6>Services</h6>
                                    <p><NavLink exact={true} activeClassName='is-active' to='/service/manpower'>Manpower Supply</NavLink></p>
                                    <p><NavLink exact={true} activeClassName='is-active' to='/service/hrSolutions'>HR Solutions</NavLink></p>
